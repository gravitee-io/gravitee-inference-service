...
public final class LlamaCppSseExample {
  ...
  public static void main(String[] args) {
    ...
    io.vertx.rxjava3.core.Vertx rxVertx =
    ...
    rxVertx
      .eventBus()
      .<Buffer>consumer(Constants.SERVICE_INFERENCE_MODELS_ADDRESS)
          ...
          try {
            ...
            if (!stream) {
              request
                .response()
                .setStatusCode(400)
                .end("stream=true is required for this example");
              return;
            }
            ...
            inferPayload.put(
              ...
              List.of(
                Map.of(
                  ...
                  "user",
                  "content",
                  payload.at("/messages/0/content").asText("")
                )
              )
            );
    ...
    System.out.println(
      "SSE example running on http://localhost:8090/v1/chat/completions"
    );
  }
  ...
  private static String loadModel(
    ...
    var reply = vertx
      .eventBus()
      .request(
        Constants.SERVICE_INFERENCE_MODELS_ADDRESS,
